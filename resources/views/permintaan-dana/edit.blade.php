<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Edit Permintaan Dana" :breadcrumbs="['Keuangan', 'Permintaan Dana', 'Edit']">
            <x-slot name="actions">
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-3 p-4 bg-amber-50 border border-amber-200 rounded-2xl">
            <div class="p-2 bg-amber-200 rounded-xl shrink-0">
                <x-heroicon-o-pencil-square class="w-5 h-5 text-amber-700"/>
            </div>
            <div>
            ...
            <x-slot name="title">
                <div class="flex items-center gap-3">
                    <div class="p-2 bg-primary/10 rounded-xl">
                        <x-heroicon-o-document-duplicate class="w-5 h-5 text-primary"/>
                    </div>
                    <div>
                        <span class="text-base font-semibold text-slate-800">Formulir Permintaan Dana</span>
                        <p class="text-xs text-slate-400 mt-0.5">Perbarui data permintaan sesuai kebutuhan</p>
                    </div>
                </div>
            </x-slot>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="catatan" rows="3" placeholder="Catatan tambahan atau penjelasan mengenai permintaan ini (opsional)..."
                                    class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none">{{ old('catatan', $permintaanDana->catatan) }}</textarea>
