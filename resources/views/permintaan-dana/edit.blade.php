<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Edit Permintaan Dana" :breadcrumbs="['Permintaan Dana', 'Edit']" />
    </x-slot>

    <div class="max-w-2xl mx-auto">
        <x-card>
            <x-slot name="title">
                <span class="text-lg font-semibold text-slate-800">Form Edit Permintaan Dana</span>
            </x-slot>
            ...
            <form action="{{ route('permintaan-dana.update', $permintaanDana) }}" method="POST">
                ...
                <div class="space-y-4" x-data="{
                    ...
                    <div>
                        ...
                        <x-text-input type="text" name="keperluan" :value="old('keperluan', $permintaanDana->keperluan)" placeholder="Deskripsi keperluan..." required />
                    ...
                    <div>
                        ...
                        <textarea name="catatan" rows="3" placeholder="Catatan tambahan (opsional)..." class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all">{{ old('catatan', $permintaanDana->catatan) }}</textarea>
