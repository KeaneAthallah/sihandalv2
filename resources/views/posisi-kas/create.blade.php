    ...
    <div class="max-w-2xl mx-auto">
        <x-card>
            <div class="mb-6 pb-5 border-b border-slate-100">
                <h2 class="text-lg font-semibold text-slate-800">Form Posisi Kas</h2>
                <p class="text-sm text-slate-400 mt-0.5">Lengkapi data berikut untuk mencatat posisi kas baru</p>
            </div>

            <form action="{{ route('posisi-kas.store') }}" method="POST" class="space-y-5">
                @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative mt-1.5">
                                ...
                                <input type="number" name="penerimaan" id="penerimaan" step="0.01" min="0" value="{{ old('penerimaan') }}" placeholder="0" class="w-full pl-[4.5rem] pr-3.5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/25 focus:border-primary transition-all">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative mt-1.5">
                                ...
                                <input type="number" name="pengeluaran" id="pengeluaran" step="0.01" min="0" value="{{ old('pengeluaran') }}" placeholder="0" class="w-full pl-[4.5rem] pr-3.5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/25 focus:border-primary transition-all">
                            </div>
