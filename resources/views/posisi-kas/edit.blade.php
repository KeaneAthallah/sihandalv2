                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="pengeluaran" id="pengeluaran" step="0.01" min="0" value="{{ old('pengeluaran', $posisiKas->pengeluaran) }}" placeholder="0" class="w-full pl-[4.5rem] pr-3 py-2 bg-white border border-slate-300 rounded-lg text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition">
                        </div>
