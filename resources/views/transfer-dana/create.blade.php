        ...
        <x-card title="Form Transfer Dana">
            <form action="{{ route('transfer-dana.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="jumlah" id="jumlah" min="0" value="{{ old('jumlah') }}" placeholder="0" required class="input pl-10 pr-3">
                        </div>
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3" placeholder="Tulis keterangan jika diperlukan" class="input">{{ old('keterangan') }}</textarea>
