        ...
        <x-card title="Edit Transfer Dana">
            <form action="{{ route('transfer-dana.update', $transferDana) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="sumber_dana" id="sumber_dana" value="{{ old('sumber_dana', $transferDana->sumber_dana) }}" placeholder="Masukkan sumber dana" required class="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition">
