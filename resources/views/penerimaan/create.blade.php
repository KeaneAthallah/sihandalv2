<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Tambah Penerimaan" :breadcrumbs="['Keuangan', 'Penerimaan', 'Tambah Baru']" />
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto">
        <x-card>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 class="text-base font-bold text-slate-800">Form Penerimaan Baru</h2>
                    <p class="text-xs text-slate-400">Lengkapi data berikut untuk menambahkan penerimaan</p>
                </div>
            </div>
                    ...
                    <div class="pb-5 border-b border-slate-100">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-sm text-slate-400 font-medium">Rp</span>
                                    <x-text-input name="realisasi" type="number" :value="old('realisasi', '0')" step="0.01" min="0" placeholder="0" class="pl-10" />
                                </div>
